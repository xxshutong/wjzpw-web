...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EduExperience.major_type'
        db.alter_column('web_eduexperience', 'major_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.MajorType'], null=True))

        # Changing field 'EduExperience.major'
        db.alter_column('web_eduexperience', 'major', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'EduExperience.major_type'
        db.alter_column('web_eduexperience', 'major_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['web.MajorType']))

        # Changing field 'EduExperience.major'
        db.alter_column('web_eduexperience', 'major', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 25, 14, 28, 1, 943866)'}),
