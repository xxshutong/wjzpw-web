...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.cp_job_last_updated'
        db.add_column('web_userprofile', 'cp_job_last_updated', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.cp_job_last_updated'
        db.delete_column('web_userprofile', 'cp_job_last_updated')
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 23, 11, 7, 32, 254119)'}),
