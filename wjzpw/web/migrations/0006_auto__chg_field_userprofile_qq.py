...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('web_userprofile', 'qq', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.qq'
        db.alter_column('web_userprofile', 'qq', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 27, 19, 51, 55, 280934)'}),
