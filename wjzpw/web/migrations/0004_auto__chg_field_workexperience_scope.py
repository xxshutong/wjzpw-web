...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkExperience.scope'
        db.alter_column('web_workexperience', 'scope', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2))


    def backwards(self, orm):
        
        # Changing field 'WorkExperience.scope'
        db.alter_column('web_workexperience', 'scope', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 19, 16, 58, 38, 486809)'}),
        ...
        'web.workexperience': {
            ...
            'resume': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['web.Resume']"}),
            'scope': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'start_date': ('django.db.models.fields.DateField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
