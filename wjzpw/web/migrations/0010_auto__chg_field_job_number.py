...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.number'
        db.alter_column('web_job', 'number', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Job.number'
        db.alter_column('web_job', 'number', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 5, 22, 38, 42, 169385)'}),
