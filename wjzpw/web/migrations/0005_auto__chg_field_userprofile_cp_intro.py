...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.cp_intro'
        db.alter_column('web_userprofile', 'cp_intro', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.cp_intro'
        db.alter_column('web_userprofile', 'cp_intro', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 27, 19, 8, 35, 50714)'}),
