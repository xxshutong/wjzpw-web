...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Position.industry'
        db.alter_column('web_position', 'industry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Industry'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Position.industry'
        db.alter_column('web_position', 'industry_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['web.Industry']))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 11, 22, 55, 17, 770618)'}),
