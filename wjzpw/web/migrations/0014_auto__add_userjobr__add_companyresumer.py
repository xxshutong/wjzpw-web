...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserJobR'
        db.create_table('web_userjobr', (
        ...
        db.send_create_signal('web', ['UserJobR'])

        # Adding model 'CompanyResumeR'
        db.create_table('web_companyresumer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.UserProfile'])),
        ...
        db.send_create_signal('web', ['CompanyResumeR'])


    def backwards(self, orm):
        
        # Deleting model 'UserJobR'
        db.delete_table('web_userjobr')

        # Deleting model 'CompanyResumeR'
        db.delete_table('web_companyresumer')
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 23, 21, 21, 44, 516919)'}),
