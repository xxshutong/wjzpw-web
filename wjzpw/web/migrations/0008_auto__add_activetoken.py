...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ActiveToken'
        db.create_table('web_activetoken', (
            ...
            ('new_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
        ))
        db.send_create_signal('web', ['ActiveToken'])


    def backwards(self, orm):
        
        # Deleting model 'ActiveToken'
        db.delete_table('web_activetoken')
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 2, 22, 16, 22, 205048)'}),
