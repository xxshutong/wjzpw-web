...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Announcement.end_date'
        db.alter_column('web_announcement', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Job.department'
        db.alter_column('web_job', 'department', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Announcement.end_date'
        db.alter_column('web_announcement', 'end_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Job.department'
        db.alter_column('web_job', 'department', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 6, 21, 51, 39, 363598)'}),
