...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('web_userprofile', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Location'], null=True))

        # Changing field 'UserProfile.census'
        db.alter_column('web_userprofile', 'census_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.City'], null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.location'
        db.alter_column('web_userprofile', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['web.Location']))

        # Changing field 'UserProfile.census'
        db.alter_column('web_userprofile', 'census_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['web.City']))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 28, 20, 41, 44, 137971)'}),
