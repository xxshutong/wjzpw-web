...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Resume.location'
        db.alter_column('web_resume', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['web.Location']))


    def backwards(self, orm):
        
        # Changing field 'Resume.location'
        db.alter_column('web_resume', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Location'], null=True))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 2, 17, 27, 15, 461115)'}),
