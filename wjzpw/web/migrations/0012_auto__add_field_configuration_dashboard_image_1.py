...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Configuration.dashboard_image_1'
        db.add_column('web_configuration', 'dashboard_image_1', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Configuration.dashboard_image_1'
        db.delete_column('web_configuration', 'dashboard_image_1')
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 6, 23, 14, 13, 208799)'}),
