...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.work_years'
        db.alter_column('web_userprofile', 'work_years', self.gf('django.db.models.fields.IntegerField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.work_years'
        db.alter_column('web_userprofile', 'work_years', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 17, 20, 58, 24, 962572)'}),
        ...
        'web.position': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'industry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['web.Industry']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'spell': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        },
        'web.province': {
        ...
        'web.userprofile': {
            ...
            'work_years': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '2'})
        },
        'web.workexperience': {
