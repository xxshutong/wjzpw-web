...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FootItem'
        db.create_table('web_footitem', (
            ...
            ('is_display', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('web', ['FootItem'])


    def backwards(self, orm):
        
        # Deleting model 'FootItem'
        db.delete_table('web_footitem')
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 27, 18, 6, 35, 38745)'}),
