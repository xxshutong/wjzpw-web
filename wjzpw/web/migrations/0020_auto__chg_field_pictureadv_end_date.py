...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PictureAdv.end_date'
        db.alter_column('web_pictureadv', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'PictureAdv.end_date'
        db.alter_column('web_pictureadv', 'end_date', self.gf('django.db.models.fields.DateField')(default=None))
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 24, 20, 29, 38, 384536)'}),
