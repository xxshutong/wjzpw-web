...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResumePositionR'
        db.create_table('web_resumepositionr', (
            ...
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Position'])),
        ))
        db.send_create_signal('web', ['ResumePositionR'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ResumePositionR'
        db.delete_table('web_resumepositionr')
    ...
    models = {
        ...
        'web.pictureadv': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 15, 23, 28, 54, 892758)'}),
