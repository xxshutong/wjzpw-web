...
class UserProfile(AbstractModel):
    ...
    work_years = models.IntegerField(u'工作经验', max_length=2, choices=WORK_YEARS_TYPE, default=0)
...
class PictureAdv(AbstractModel):
    ...
    width = models.IntegerField(_(u'图片宽度'), null=True, blank=True, help_text=_(u'首页图片广告宽度尺寸分三种：161.5(输入的时候用161), 333, 1019'))
    height = models.IntegerField(_(u'图片高度'), null=True, blank=True, help_text=_(u'首页图片广告高度一般为60px'))
