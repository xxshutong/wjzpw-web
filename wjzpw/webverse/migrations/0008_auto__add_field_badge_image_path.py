...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.image_path'
        db.add_column('webverse_badge', 'image_path', self.gf('django.db.models.fields.files.ImageField')(default='static/upload/images/badge_blank.png', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.image_path'
        db.delete_column('webverse_badge', 'image_path')
