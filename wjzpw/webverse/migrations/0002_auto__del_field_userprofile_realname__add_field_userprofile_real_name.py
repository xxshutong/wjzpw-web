...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('webverse_userprofile', 'real_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('webverse_userprofile', 'real_name')
