...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('webverse_userreward', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.UserProfile'])),
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.Reward'])),
            ('validated', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('validated_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('webverse', ['UserReward'])

        # Renaming column for 'Reward.eligibility' to match new field type.
        db.rename_column('webverse_reward', 'eligibility_id', 'eligibility')
        # Changing field 'Reward.eligibility'
        db.alter_column('webverse_reward', 'eligibility', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Removing index on 'Reward', fields ['eligibility']
        db.delete_index('webverse_reward', ['eligibility_id'])


    def backwards(self, orm):
        
        # Adding index on 'Reward', fields ['eligibility']
        db.create_index('webverse_reward', ['eligibility_id'])

        # Deleting model 'UserReward'
        db.delete_table('webverse_userreward')

        # Renaming column for 'Reward.eligibility' to match new field type.
        db.rename_column('webverse_reward', 'eligibility', 'eligibility_id')
        # Changing field 'Reward.eligibility'
        db.alter_column('webverse_reward', 'eligibility_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'webverse.userreward': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webverse.UserProfile']"}),
            'validated': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'validated_date': ('django.db.models.fields.DateField', [], {})
        }
    }
