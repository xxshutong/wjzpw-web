...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('webverse_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('webverse_userprofile', 'access_token')
