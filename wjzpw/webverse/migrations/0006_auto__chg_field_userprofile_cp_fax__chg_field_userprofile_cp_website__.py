...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.cp_fax'
        db.alter_column('webverse_userprofile', 'cp_fax', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'UserProfile.cp_website'
        db.alter_column('webverse_userprofile', 'cp_website', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserProfile.cp_industry'
        db.alter_column('webverse_userprofile', 'cp_industry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.Industry'], null=True))

        # Changing field 'UserProfile.cp_telephone'
        db.alter_column('webverse_userprofile', 'cp_telephone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'UserProfile.cp_mobile_phone'
        db.alter_column('webverse_userprofile', 'cp_mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.cp_fax'
        db.alter_column('webverse_userprofile', 'cp_fax', self.gf('django.db.models.fields.CharField')(default=None, max_length=15))

        # Changing field 'UserProfile.cp_website'
        db.alter_column('webverse_userprofile', 'cp_website', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))

        # Changing field 'UserProfile.cp_industry'
        db.alter_column('webverse_userprofile', 'cp_industry_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['webverse.Industry']))

        # Changing field 'UserProfile.cp_telephone'
        db.alter_column('webverse_userprofile', 'cp_telephone', self.gf('django.db.models.fields.CharField')(default=None, max_length=15))

        # Changing field 'UserProfile.cp_mobile_phone'
        db.alter_column('webverse_userprofile', 'cp_mobile_phone', self.gf('django.db.models.fields.CharField')(default=None, max_length=15))
    ...
    models = {
        ...
        'webverse.userprofile': {
            ...
            'cp_industry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webverse.Industry']", 'null': 'True', 'blank': 'True'}),
            ...
            'work_years': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'max_length': '2', 'null': 'True', 'blank': 'True'})
        }
    }
