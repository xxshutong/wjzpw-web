...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.participation_count'
        db.alter_column('webverse_badge', 'participation_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Badge.consecutive_count'
        db.alter_column('webverse_badge', 'consecutive_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Badge.duration_minute'
        db.alter_column('webverse_badge', 'duration_minute', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Badge.day_range'
        db.alter_column('webverse_badge', 'day_range', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Badge.participation_count'
        db.alter_column('webverse_badge', 'participation_count', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Badge.consecutive_count'
        db.alter_column('webverse_badge', 'consecutive_count', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Badge.duration_minute'
        db.alter_column('webverse_badge', 'duration_minute', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Badge.day_range'
        db.alter_column('webverse_badge', 'day_range', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'webverse.badge': {
            ...
            'consecutive_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'day_range': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'duration_minute': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_path': ('django.db.models.fields.files.ImageField', [], {'max_length': '255'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'participation_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
        },
        ...
        'webverse.redemption': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webverse.UserProfile']"}),
            'validated': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'validated_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'})
        },
        'webverse.reward': {
            'Meta': {'object_name': 'Reward'},
            'eligibility': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['webverse.UserProfile']", 'through': "orm['webverse.UserReward']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
