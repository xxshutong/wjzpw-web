...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserReward.validated_date'
        db.delete_column('webverse_userreward', 'validated_date')

        # Deleting field 'UserReward.validated'
        db.delete_column('webverse_userreward', 'validated')

        # Deleting field 'Redemption.points_deducted'
        db.delete_column('webverse_redemption', 'points_deducted')

        # Adding field 'Redemption.validated'
        db.add_column('webverse_redemption', 'validated', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Redemption.validated_date'
        db.add_column('webverse_redemption', 'validated_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserReward.validated_date'
        db.add_column('webverse_userreward', 'validated_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'UserReward.validated'
        db.add_column('webverse_userreward', 'validated', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Redemption.points_deducted'
        db.add_column('webverse_redemption', 'points_deducted', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Redemption.validated'
        db.delete_column('webverse_redemption', 'validated')

        # Deleting field 'Redemption.validated_date'
        db.delete_column('webverse_redemption', 'validated_date')
    ...
    models = {
        ...
        'webverse.reward': {
            ...
            'eligibility': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
