...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.parent_id'
        db.add_column('webverse_userprofile', 'parent_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.parent_id'
        db.delete_column('webverse_userprofile', 'parent_id')
