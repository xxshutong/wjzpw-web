...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.is_deleted'
        db.add_column('webverse_userprofile', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.is_deleted'
        db.delete_column('webverse_userprofile', 'is_deleted')
