...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webverse_userprofile', 'work_years', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))
    ...
    models = {
        ...
        'webverse.userprofile': {
            ...
            'work_years': ('django.db.models.fields.IntegerField', [], {'max_length': '2'})
        }
    }
