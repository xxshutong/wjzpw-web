...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.activity'
        db.alter_column('webverse_badge', 'activity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.Activity'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Badge.activity'
        raise RuntimeError("Cannot reverse this migration. 'Badge.activity' and its values cannot be restored.")
    ...
    models = {
        ...
        'webverse.badge': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webverse.Activity']", 'null': 'True', 'blank': 'True'}),
