...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('webverse_userprofile', 'realname', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.realname'
        db.delete_column('webverse_userprofile', 'realname')
