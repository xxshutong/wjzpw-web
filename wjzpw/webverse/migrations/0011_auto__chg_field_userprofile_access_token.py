...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webverse_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=1024, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.access_token'
        db.alter_column('webverse_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=103, null=True))
