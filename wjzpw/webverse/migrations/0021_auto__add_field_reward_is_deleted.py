...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reward.is_deleted'
        db.add_column('webverse_reward', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reward.is_deleted'
        db.delete_column('webverse_reward', 'is_deleted')
