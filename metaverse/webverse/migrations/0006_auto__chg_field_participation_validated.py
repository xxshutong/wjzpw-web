...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participation.validated'
        db.alter_column('webverse_participation', 'validated', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Participation.validated'
        db.alter_column('webverse_participation', 'validated', self.gf('django.db.models.fields.BooleanField')())
