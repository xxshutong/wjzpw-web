...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.image_path'
        db.add_column('webverse_activity', 'image_path', self.gf('django.db.models.fields.files.ImageField')(default='static/upload/images/activity_blank.png', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.image_path'
        db.delete_column('webverse_activity', 'image_path')
