...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Reward.eligibility'
        db.delete_column('webverse_reward', 'eligibility')


    def backwards(self, orm):
        
        # Adding field 'Reward.eligibility'
        db.add_column('webverse_reward', 'eligibility', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
