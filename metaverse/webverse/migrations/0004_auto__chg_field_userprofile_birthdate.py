...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.birthdate'
        db.alter_column('webverse_userprofile', 'birthdate', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.birthdate'
        db.alter_column('webverse_userprofile', 'birthdate', self.gf('django.db.models.fields.DateField')(default=None))
