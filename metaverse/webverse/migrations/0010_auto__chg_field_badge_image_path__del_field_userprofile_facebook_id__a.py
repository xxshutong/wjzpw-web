...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.image_path'
        db.alter_column('webverse_badge', 'image_path', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

        # Deleting field 'UserProfile.facebook_id'
        db.delete_column('webverse_userprofile', 'facebook_id')

        # Adding field 'UserProfile.expires'
        db.add_column('webverse_userprofile', 'expires', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.uid'
        db.add_column('webverse_userprofile', 'uid', self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True, blank=True), keep_default=False)

        # Changing field 'UserProfile.access_token'
        db.alter_column('webverse_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=103, unique=True, null=True))

        # Adding unique constraint on 'UserProfile', fields ['access_token']
        db.create_unique('webverse_userprofile', ['access_token'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'UserProfile', fields ['access_token']
        db.delete_unique('webverse_userprofile', ['access_token'])

        # Changing field 'Badge.image_path'
        db.alter_column('webverse_badge', 'image_path', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Adding field 'UserProfile.facebook_id'
        db.add_column('webverse_userprofile', 'facebook_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.expires'
        db.delete_column('webverse_userprofile', 'expires')

        # Deleting field 'UserProfile.uid'
        db.delete_column('webverse_userprofile', 'uid')

        # Changing field 'UserProfile.access_token'
        db.alter_column('webverse_userprofile', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
    ...
    models = {
        ...
        'webverse.userprofile': {
            'Meta': {'unique_together': "(('user', 'uid'), ('access_token', 'expires'))", 'object_name': 'UserProfile'},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '103', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
