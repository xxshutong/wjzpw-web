...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participation.user'
        db.alter_column('webverse_participation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.UserProfile']))

        # Changing field 'Achievement.user'
        db.alter_column('webverse_achievement', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.UserProfile']))

        # Changing field 'Redemption.user'
        db.alter_column('webverse_redemption', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.UserProfile']))

        # Changing field 'Reward.user'
        db.alter_column('webverse_reward', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webverse.UserProfile']))


    def backwards(self, orm):
        
        # Changing field 'Participation.user'
        db.alter_column('webverse_participation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Achievement.user'
        db.alter_column('webverse_achievement', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Redemption.user'
        db.alter_column('webverse_redemption', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Reward.user'
        db.alter_column('webverse_reward', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
